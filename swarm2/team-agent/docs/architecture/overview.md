...
Three-tier certificate authority hierarchy:
...
4. **Digital Signatures**: All workflow outputs cryptographically signed
5. **Certificate Revocation**: CRL and OCSP for real-time revocation checking
6. **Trust Scoring**: Agent reputation tracking (0-100 scale)

See [PKI Control Plane](../features/pki-control-plane.md) for details.
...
- `test_a2a_system.py`: A2A communication and capability matching (20 tests, 80% coverage)
- `test_pki.py`: PKI infrastructure (107 tests total)
...
**Test Coverage**:
- PKI System: 107 tests, ~85% coverage
- A2A System: 20 tests, 80% coverage
- Trust Scoring: 31 tests, ~90% coverage
- Orchestrator: 5 tests, ~75% coverage
- **Overall: 163 tests, ~82% coverage**
...
- [A2A Architecture](a2a.md) - Agent-to-Agent communication and capability discovery
- [PKI Control Plane](../features/pki-control-plane.md) - Security infrastructure
- [Development Guide](../development/setup.md) - How to extend the system
- [A2A System](../features/a2a-system.md) - Implementation details
