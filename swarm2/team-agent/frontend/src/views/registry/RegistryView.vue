    ...
    <div class="registry-view">
      ...
      <Message severity="info" :closable="false">
        <div class="info-content">
          <h3>Agent-to-Agent Capability Registry</h3>
          <p>Discover and manage available capabilities from registered providers. Browse by type, trust score, reputation, and pricing.</p>
        </div>
      </Message>
